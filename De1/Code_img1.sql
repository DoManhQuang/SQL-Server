...
on primary ( name = 'QLBanHang_dat' ,filename = 'E:\SQL Sever\De1\QLBanHang_dat.mdf' ,size = 5mb , maxsize = 10mb , filegrowth = 20%)
log on ( name = 'QLBanHang_log' ,filename = 'E:\SQL Sever\De1\QLBanHang_dat.ldf' ,size = 5mb , maxsize = 10mb , filegrowth = 20%)
go
use QLBanHang
go
